...
proto.zipkin.proto3.Span = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.zipkin.proto3.Span.repeatedFields_,
    null,
  );
};
  ...
  proto.zipkin.proto3.Span.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        ...
        localEndpoint:
          (f = msg.getLocalEndpoint()) &&
          proto.zipkin.proto3.Endpoint.toObject(includeInstance, f),
        remoteEndpoint:
          (f = msg.getRemoteEndpoint()) &&
          proto.zipkin.proto3.Endpoint.toObject(includeInstance, f),
        annotationsList: jspb.Message.toObjectList(
          msg.getAnnotationsList(),
          proto.zipkin.proto3.Annotation.toObject,
          includeInstance,
        ),
        tagsMap: (f = msg.getTagsMap())
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 8:
        ...
        reader.readMessage(
          value,
          proto.zipkin.proto3.Endpoint.deserializeBinaryFromReader,
        );
      ...
      case 10:
        ...
        reader.readMessage(
          value,
          proto.zipkin.proto3.Annotation.deserializeBinaryFromReader,
        );
...
proto.zipkin.proto3.Span.prototype.getKind = function() {
  return /** @type {!proto.zipkin.proto3.Span.Kind} */ (jspb.Message.getFieldWithDefault(
    this,
    4,
    0,
  ));
...
proto.zipkin.proto3.Span.prototype.getLocalEndpoint = function() {
  return /** @type{?proto.zipkin.proto3.Endpoint} */ (jspb.Message.getWrapperField(
    this,
    proto.zipkin.proto3.Endpoint,
    8,
  ));
};
...
proto.zipkin.proto3.Span.prototype.getAnnotationsList = function() {
  return /** @type{!Array<!proto.zipkin.proto3.Annotation>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.zipkin.proto3.Annotation,
    10,
  ));
};
 ...
 */
proto.zipkin.proto3.Span.prototype.addAnnotations = function(
  opt_value,
  opt_index,
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.zipkin.proto3.Endpoint.prototype.toObject = function(
    opt_includeInstance,
  ) {
 ...
 * @return {!proto.zipkin.proto3.Endpoint}
 */
proto.zipkin.proto3.Endpoint.deserializeBinaryFromReader = function(
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.zipkin.proto3.Endpoint.serializeBinaryToWriter = function(
  message,
  writer,
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.zipkin.proto3.Annotation.prototype.toObject = function(
    opt_includeInstance,
  ) {
...
proto.zipkin.proto3.Annotation.deserializeBinary = function(bytes) {
  ...
  return proto.zipkin.proto3.Annotation.deserializeBinaryFromReader(
    msg,
    reader,
  );
};
 ...
 * @return {!proto.zipkin.proto3.Annotation}
 */
proto.zipkin.proto3.Annotation.deserializeBinaryFromReader = function(
  msg,
  reader,
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.zipkin.proto3.Annotation.serializeBinaryToWriter = function(
  message,
  writer,
) {
  var f = undefined;
...
proto.zipkin.proto3.ListOfSpans = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.zipkin.proto3.ListOfSpans.repeatedFields_,
    null,
  );
};
goog.inherits(proto.zipkin.proto3.ListOfSpans, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.zipkin.proto3.ListOfSpans.displayName =
    'proto.zipkin.proto3.ListOfSpans';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.zipkin.proto3.ListOfSpans.prototype.toObject = function(
    opt_includeInstance,
  ) {
  ...
  proto.zipkin.proto3.ListOfSpans.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        spansList: jspb.Message.toObjectList(
          msg.getSpansList(),
          proto.zipkin.proto3.Span.toObject,
          includeInstance,
        ),
      };
...
proto.zipkin.proto3.ListOfSpans.deserializeBinary = function(bytes) {
  ...
  return proto.zipkin.proto3.ListOfSpans.deserializeBinaryFromReader(
    msg,
    reader,
  );
};
 ...
 * @return {!proto.zipkin.proto3.ListOfSpans}
 */
proto.zipkin.proto3.ListOfSpans.deserializeBinaryFromReader = function(
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.zipkin.proto3.Span.deserializeBinaryFromReader,
        );
        msg.addSpans(value);
        break;
      default:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.zipkin.proto3.ListOfSpans.serializeBinaryToWriter = function(
  message,
  writer,
) {
  var f = undefined;
...
proto.zipkin.proto3.ListOfSpans.prototype.getSpansList = function() {
  return /** @type{!Array<!proto.zipkin.proto3.Span>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.zipkin.proto3.Span,
    1,
  ));
};
 ...
 * @return {!proto.zipkin.proto3.Span}
 */
proto.zipkin.proto3.ListOfSpans.prototype.addSpans = function(
  opt_value,
  opt_index,
) {
  return jspb.Message.addToRepeatedWrapperField(
