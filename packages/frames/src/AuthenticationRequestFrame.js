...
export function serializeAuthenticationRequestFrame(
      frame: AuthenticationRequestFrame
      ): ByteBuffer {

	const accessTokenLength = getByteLength(frame.accessToken);
	invariant(
	accessTokenLength === ACCESS_TOKEN_SIZE,
	'AuthenticationRequestFrame: invalid access token size: found %s, expected %s',
	accessTokenLength,
	ACCESS_TOKEN_SIZE,
	);
...
export function deserializeAuthenticationRequestFrame(
	buffer: ByteBuffer,
	flags: number,
	seqId: Long) : SharedSecretFrame {
